...
# Load pre-trained T5 model for sequence classification
...
for epoch in range(num_epochs):
    ...
    flat_predictions = [word for pred in predictions for word in pred.split()]
    flat_labels = [word for label in y_val for word in tokenizer.decode(label, skip_special_tokens=True).split()]

    # Calculate precision, recall, and F1 score using seqeval
    ...
    print(classification_report([flat_labels], [flat_predictions]))
...
# Calculate precision, recall, and F1 score using seqeval
precision_test = precision_score([flat_test_labels], [flat_test_predictions])
recall_test = recall_score([flat_test_labels], [flat_test_predictions])
f1_test = f1_score([flat_test_labels], [flat_test_predictions])

print("Test Set Metrics:")
print(f"Precision: {precision_test}, Recall: {recall_test}, F1: {f1_test}")
